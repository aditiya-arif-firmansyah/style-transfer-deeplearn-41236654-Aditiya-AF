# -*- coding: utf-8 -*-
"""Deeplearn_NST_41236654_Aditiya AF

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1yFgm6-VHJXnbf654BQEdybc9xPrxwGB9
"""

# ==============================================================================
# TUGAS INDIVIDU: IMPLEMENTASI NEURAL STYLE TRANSFER (NST)
...
def run_style_transfer(content_path, style_path, num_iterations=ITERATIONS):
    ...
    style_features, content_features_dict = get_feature_representations(
    ...
    cfg = {
        ...
        'content_features': list(content_features_dict.values()) # <--- FIX: Pass the values directly
    }
...
# --- 7. Eksekusi Model ---
# Catatan: Ketika Anda menjalankan ini di Google Colab, Anda perlu memastikan
# bahwa file 'images.jpg' dan 'images.png' sudah diunggah ke environment Colab.

# Pastikan Anda memanggil fungsi utama:
# hasil_gambar = run_style_transfer(CONTENT_PATH, STYLE_PATH)

# Karena di lingkungan ini kita tidak bisa mengeksekusi I/O file,
# Saya hanya akan menunjukkan struktur kode yang harus Anda jalankan.
# Di Colab, Anda hanya perlu menjalankan:
...
# --- Definisi Jalur (disalin dari sel utama untuk kemandirian) ---
CONTENT_PATH = '/content/drive/MyDrive/deeplearn/kucing.jpg'
STYLE_PATH = '/content/drive/MyDrive/deeplearn/batik1.png'
OUTPUT_FILENAME = 'hasil_style_transfer.png'

# DEBUG: Menampilkan isi direktori dan path saat ini untuk verifikasi file
print(f"Current working directory: {os.getcwd()}")
print(f"Files in current directory: {os.listdir('.')}")

# Muat dan tampilkan gambar konten asli
try:
    img_content = Image.open(CONTENT_PATH)
    print(f"Menampilkan gambar konten: {CONTENT_PATH}")
    display(img_content)
except FileNotFoundError:
    print(f"Error: File konten '{CONTENT_PATH}' tidak ditemukan.")
except Exception as e:
    print(f"Terjadi kesalahan saat menampilkan gambar konten: {e}")

# Muat dan tampilkan gambar gaya asli
try:
    img_style = Image.open(STYLE_PATH)
    print(f"Menampilkan gambar gaya: {STYLE_PATH}")
    display(img_style)
except FileNotFoundError:
    print(f"Error: File gaya '{STYLE_PATH}' tidak ditemukan.")
except Exception as e:
    print(f"Terjadi kesalahan saat menampilkan gambar gaya: {e}")

# Muat dan tampilkan gambar hasil style transfer
try:
    if os.path.exists(OUTPUT_FILENAME):
        img_result = Image.open(OUTPUT_FILENAME)
        print(f"Menampilkan gambar hasil style transfer: {OUTPUT_FILENAME}")
        display(img_result)
    else:
        print(f"Error: File '{OUTPUT_FILENAME}' tidak ditemukan di sistem file. Pastikan proses style transfer berhasil dan file telah disimpan.")
except Exception as e:
    print(f"Terjadi kesalahan saat menampilkan gambar hasil: {e}")
...
# Muat dan tampilkan gambar hasil
try:
    img_result = Image.open(OUTPUT_FILENAME)
    print(f"Menampilkan gambar hasil style transfer: {OUTPUT_FILENAME}")
    display(img_result)
except FileNotFoundError:
    print(f"Error: File '{OUTPUT_FILENAME}' tidak ditemukan. Pastikan proses style transfer berhasil dan file telah disimpan.")
except Exception as e:
